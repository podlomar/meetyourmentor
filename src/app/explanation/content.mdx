...
- **Skóre účastníka** - pořadí protějšku, se kterým byl účastník spárován v jeho seznamu preferencí. Pokud napřklad mentor získal v párování mentee, která byla na prvním místě v jeho seznamu preferencí, jeho skóre je 0, pokud byla na druhém místě, jeho skóre je 1 atd. Tedy čím menší skóre, tím je účastník spokojenější s výsledkem.
...
1. Najdi všechna stabilní párování.
